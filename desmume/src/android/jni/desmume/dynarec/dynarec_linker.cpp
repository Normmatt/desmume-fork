...
{
	//if(b == 0x021d5640) LOGE("yo %x", _MMU_read32<ARMCPU_ARM9, MMU_AT_DATA>(0x021d5640));
	...
	//if(b == 0x021d5640) LOGE("yo after %x", _MMU_read32<ARMCPU_ARM9, MMU_AT_DATA>(0x021d5640));
	//if(_MMU_read32<ARMCPU_ARM9, MMU_AT_DATA>(0x021d5640) == 0x020cb550) joke=true;
}
