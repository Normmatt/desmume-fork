...
LOCAL_CFLAGS			:= -DANDROID -DNO_MEMDEBUG -DNO_GPUDEBUG -DHAVE_JIT -DHAVE_LIBAGG -DHAVE_LIBZ -DCOMPRESS_MT #-march=armv7-a -mfloat-abi=softfp -mfpu=vfpv3-d16
LOCAL_LDLIBS 			:= -llog -lz -lEGL -lGLESv2 -ljnigraphics -lOpenSLES -landroid #-march=armv7-a -mfloat-abi=softfp -mfpu=vfpv3-d16 
