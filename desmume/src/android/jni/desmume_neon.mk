...
LOCAL_CFLAGS			:= -DANDROID -DUSE_EGL -DUSE_GLES -DNO_MEMDEBUG -DNO_GPUDEBUG -DHAVE_JIT -DHAVE_LIBAGG -DHAVE_LIBZ -DCOMPRESS_MT -DHAVE_NEON=1 -march=armv7-a -mfloat-abi=softfp -mfpu=neon -mtune=cortex-a9
LOCAL_LDLIBS 			:= -llog -lz -lEGL -lGLESv1_CM -ljnigraphics -lOpenSLES -landroid -march=armv7-a -mfloat-abi=softfp -mfpu=neon -mtune=cortex-a9 -Wl,--fix-cortex-a8
