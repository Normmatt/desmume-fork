...
public class Settings extends PreferenceActivity {
	...
	public static final String ADVANCED_TIMING = "AdvancedTiming";
	...
	public static void applyDefaults(Context context) {
		...
		if(prefs.contains(INSTALLED_RELEASE) && prefs.contains(FRAME_SKIP)) {
		...
		if(!prefs.contains(ADVANCED_TIMING))
			editor.putBoolean(ADVANCED_TIMING, false);
