...
DCL_OP_START(OP_SWI_THUMB)
	...
	DCL_OP_METHOD(OP_SWI_THUMB) HOT
...
#define DCL_OP2_ARG1_HOT(name, op1, op2, arg) \
	DCL_OP_START(name) \
		op1##_DATA \
		op2##_DATA \
		DCL_OP_COMPILER(name) \
...
#define DCL_OP2_ARG2_HOT(name, op1, op2, arg1, arg2) \
	DCL_OP_START(name) \
		op1##_DATA \
		op2##_DATA \
		DCL_OP_COMPILER(name) \
...
#define DCL_OP2EX_ARG2_HOT(name, op1, op2, opex, arg1, arg2) \
	DCL_OP_START(name) \
		op1##_DATA \
		op2##_DATA \
		DCL_OP_COMPILER(name) \
...
#define DCL_OP_DATAPROCESS_HOT(name, op1, op2, arg1, arg2) \
	DCL_OP_START(name) \
		op1##_DATA \
		op2##_DATA \
		DCL_OP_COMPILER(name) \
...
#define DCL_OP_DATAPROCESS_EX_HOT(name, op1, op2, opex, arg1, arg2) \
	DCL_OP_START(name) \
		op1##_DATA \
		op2##_DATA \
		DCL_OP_COMPILER(name) \
		...
		DCL_OP_METHOD3(name) HOT \
			op1; \
			opex; \
			op2(arg1, arg2); \
		} \
		DCL_OP_METHOD4(name) HOT \
			op1; \
			opex; \
			op2##_WR15(arg1, arg2); \
		} \
...
DCL_OP_DATAPROCESS_HOT(OP_AND_LSL_IMM, LSL_IMM, OP_AND, 1, 3)
...
DCL_OP_DATAPROCESS_HOT(OP_AND_IMM_VAL, IMM_VALUE, OP_AND, 1, 3)
...
DCL_OP_DATAPROCESS_HOT(OP_ADD_LSL_IMM, LSL_IMM, OP_ADD, 1, 3)
...
DCL_OP_DATAPROCESS_HOT(OP_ADD_IMM_VAL, IMM_VALUE, OP_ADD, 1, 3)
...
DCL_OP2_ARG1_HOT(OP_TST_LSL_IMM, S_LSL_IMM, OP_TST, 1)
...
DCL_OP2_ARG1_HOT(OP_TST_IMM_VAL, S_IMM_VALUE, OP_TST, 1)
...
DCL_OP2_ARG1_HOT(OP_CMP_LSL_IMM, LSL_IMM, OP_CMP, 1)
...
DCL_OP2_ARG1_HOT(OP_CMP_IMM_VAL, IMM_VALUE, OP_CMP, 1)
...
DCL_OP_DATAPROCESS_HOT(OP_MOV_LSL_IMM, LSL_IMM, OP_MOV, 1, 3)
...
DCL_OP_DATAPROCESS_HOT(OP_MOV_IMM_VAL, IMM_VALUE, OP_MOV, 1, 3)
...
DCL_OP2_ARG2_HOT(OP_MSR_CPSR, OPERAND, MSR_CPSR, operand, 1)
...
#define DCL_LDR_OP_HOT(name, op1, op2, opex, arg1, arg2) \
	DCL_OP_START(name) \
		op1##_DATA \
		op2##_DATA \
		DCL_OP_COMPILER(name) \
...
DCL_LDR_OP_HOT(OP_LDR_P_IMM_OFF, IMM_OFF_12, OP_LDR_PRE, u32 adr=*DATA(r_16)+DATA(offset), 3, 5)
...
DCL_OP2EX_ARG2_HOT(OP_STR_P_IMM_OFF, IMM_OFF_12, OP_STR_PRE, u32 adr=*DATA(r_16)+DATA(offset), 2, 2)
